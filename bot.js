...
- Сначала пойми мысль целиком, потом излагай её заново с нуля — своими словами, не подглядывая в исходник предложение за предложением. Это пересказ по памяти, а не синонимайзер и не построчный перевод.
- Меняй структуру, а не только слова: не обязан идти по тексту оригинала абзац за абзацем в том же порядке — можешь начать с другого факта, объединить две мысли в одну или, наоборот, разбить одну на две. Не копируй разбивку на предложения: где в оригинале три коротких, у тебя может быть одно длинное, и наоборот.
